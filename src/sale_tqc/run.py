...
from sale_tqc.algorithm import SALETQCAlgorithm
from jax_rl.replay_memory import SimpleReplayMemory, LAPReplayMemory
from jax_rl.utils import setup_logger


def args_for_sale_tqc(func: Callable) -> Callable:
    """Argument for SALE TQC."""
...
def run_sale_tqc(
    ...
    target_update_rate: int = 500,
    total_timesteps: int = 3_000_000,
    ent_coef: float = 0.1,
    save_path: str = "./save/SALE_TQC",
